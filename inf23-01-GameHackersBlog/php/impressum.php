...
<body>
    ...
    <main class="card">
        ...
        <p>E-Mail: dominik.neubauer@wuerth-industrie.com</p>
        ...
        <p>Zuständige Aufsichtsbehörde: Industrie- und Handelskammer Musterstadt</p>
        <p>Berufsbezeichnung: Informatiker</p>
        <p>Haftungsausschluss: Für die Inhalte externer Links übernehmen wir keine Haftung.</p>
