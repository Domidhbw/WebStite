      ...
      <main class="ContainerContent">
         ...
         <article>
            ...
            <div class="ArticleText">
               ...
               <img src="Pictures/CheatEngineContent/0.jpg" alt="CheatEngine software with the atach icon highlighted" title="CheatEngine software with the atach icon highlighted">
               ...
               <h1>Step 2: Exact Value scanning</h1>
               ...
               <img  src="Pictures/CheatEngineContent/1.png" alt="CheatEngine software with the First Scan, value:, Scan Type and value Type fields highlighted" title="CheatEngine software with the First Scan, value:, Scan Type and value Type fields highlighted" >
               <p>You Should see a list of addresses, in the found address list, like this.</p>
               <img src="Pictures/CheatEngineContent/2.png" alt="CheatEngine software with the adress field highlighted" title="CheatEngine software with the adress field highlighted">
               ...
               <img src="Pictures/CheatEngineContent/3.png" alt="CheatEngine software with the Next Scan and value field highlighted as well as one memory adress" title="CheatEngine software with the Next Scan and value field highlighted as well as one memory adress">
               ...
               <img src="Pictures/CheatEngineContent/4.png" alt="CheatEngine software with only one adress wich is highlighted" title="CheatEngine software with only one adress wich is highlighted">
               ...
               <img src="Pictures/CheatEngineContent/5.png" alt="Only the bottom of the CheatEngine software is visible and it shows an adress" title="Only the bottom of the CheatEngine software is visible and it shows an adress" >
